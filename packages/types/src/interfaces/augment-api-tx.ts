...
import type { AcalaPrimitivesAuthoritysOriginId, AcalaPrimitivesCurrencyAssetMetadata, AcalaPrimitivesCurrencyCurrencyId, AcalaRuntimeOriginCaller, AcalaRuntimeRuntimeParameters, AcalaRuntimeScheduledTasks, AcalaRuntimeSessionKeys, CumulusPrimitivesCoreAggregateMessageOrigin, CumulusPrimitivesParachainInherentParachainInherentData, EthereumTransactionEip2930AccessListItem, EthereumTransactionLegacyTransactionAction, FrameSupportPreimagesBounded, FrameSupportScheduleDispatchTime, ModuleHomaModuleUnlockChunk, ModuleHomaValidatorListSlashInfo, ModuleSupportDexAggregatedSwapPath, ModuleSupportDexSwapLimit, ModuleSupportIncentivesPoolId, ModuleXcmInterfaceModuleXcmInterfaceOperation, OrmlTraitsChangeOption, OrmlTraitsChangeU128, OrmlVestingVestingSchedule, OrmlXtokensMigrationPhase, PalletBalancesAdjustmentDirection, PalletDemocracyConviction, PalletDemocracyMetadataOwner, PalletDemocracyVoteAccountVote, PalletMultisigTimepoint, RuntimeCommonProxyType, SpWeightsWeightV2Weight, StagingXcmExecutorAssetTransferTransferType, StagingXcmV5Location, XcmV3WeightLimit, XcmVersionedAsset, XcmVersionedAssetId, XcmVersionedAssets, XcmVersionedLocation, XcmVersionedXcm } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    assetRegistry: {
      ...
      registerForeignAsset: AugmentedSubmittable<(location: XcmVersionedLocation | { V3: any } | { V4: any } | { V5: any } | string | Uint8Array, metadata: AcalaPrimitivesCurrencyAssetMetadata | { name?: any; symbol?: any; decimals?: any; minimalBalance?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [XcmVersionedLocation, AcalaPrimitivesCurrencyAssetMetadata]>;
      ...
      updateForeignAsset: AugmentedSubmittable<(foreignAssetId: u16 | AnyNumber | Uint8Array, location: XcmVersionedLocation | { V3: any } | { V4: any } | { V5: any } | string | Uint8Array, metadata: AcalaPrimitivesCurrencyAssetMetadata | { name?: any; symbol?: any; decimals?: any; minimalBalance?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u16, XcmVersionedLocation, AcalaPrimitivesCurrencyAssetMetadata]>;
    ...
    evm: {
      call: AugmentedSubmittable<(target: H160 | string | Uint8Array, input: Bytes | string | Uint8Array, value: Compact<u128> | AnyNumber | Uint8Array, gasLimit: Compact<u64> | AnyNumber | Uint8Array, storageLimit: Compact<u32> | AnyNumber | Uint8Array, accessList: Vec<EthereumTransactionEip2930AccessListItem> | (EthereumTransactionEip2930AccessListItem | { address?: any; storageKeys?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [H160, Bytes, Compact<u128>, Compact<u64>, Compact<u32>, Vec<EthereumTransactionEip2930AccessListItem>]>;
      create: AugmentedSubmittable<(input: Bytes | string | Uint8Array, value: Compact<u128> | AnyNumber | Uint8Array, gasLimit: Compact<u64> | AnyNumber | Uint8Array, storageLimit: Compact<u32> | AnyNumber | Uint8Array, accessList: Vec<EthereumTransactionEip2930AccessListItem> | (EthereumTransactionEip2930AccessListItem | { address?: any; storageKeys?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Bytes, Compact<u128>, Compact<u64>, Compact<u32>, Vec<EthereumTransactionEip2930AccessListItem>]>;
      create2: AugmentedSubmittable<(input: Bytes | string | Uint8Array, salt: H256 | string | Uint8Array, value: Compact<u128> | AnyNumber | Uint8Array, gasLimit: Compact<u64> | AnyNumber | Uint8Array, storageLimit: Compact<u32> | AnyNumber | Uint8Array, accessList: Vec<EthereumTransactionEip2930AccessListItem> | (EthereumTransactionEip2930AccessListItem | { address?: any; storageKeys?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Bytes, H256, Compact<u128>, Compact<u64>, Compact<u32>, Vec<EthereumTransactionEip2930AccessListItem>]>;
      ...
      ethCall: AugmentedSubmittable<(action: EthereumTransactionLegacyTransactionAction | { Call: any } | { Create: any } | string | Uint8Array, input: Bytes | string | Uint8Array, value: Compact<u128> | AnyNumber | Uint8Array, gasLimit: Compact<u64> | AnyNumber | Uint8Array, storageLimit: Compact<u32> | AnyNumber | Uint8Array, accessList: Vec<EthereumTransactionEip2930AccessListItem> | (EthereumTransactionEip2930AccessListItem | { address?: any; storageKeys?: any } | string | Uint8Array)[], validUntil: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [EthereumTransactionLegacyTransactionAction, Bytes, Compact<u128>, Compact<u64>, Compact<u32>, Vec<EthereumTransactionEip2930AccessListItem>, Compact<u32>]>;
      ethCallV2: AugmentedSubmittable<(action: EthereumTransactionLegacyTransactionAction | { Call: any } | { Create: any } | string | Uint8Array, input: Bytes | string | Uint8Array, value: Compact<u128> | AnyNumber | Uint8Array, gasPrice: Compact<u64> | AnyNumber | Uint8Array, gasLimit: Compact<u64> | AnyNumber | Uint8Array, accessList: Vec<EthereumTransactionEip2930AccessListItem> | (EthereumTransactionEip2930AccessListItem | { address?: any; storageKeys?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [EthereumTransactionLegacyTransactionAction, Bytes, Compact<u128>, Compact<u64>, Compact<u64>, Vec<EthereumTransactionEip2930AccessListItem>]>;
    ...
    homa: {
      ...
      forceBumpCurrentEra: AugmentedSubmittable<(bumpEra: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32]>;
    ...
    homaValidatorList: {
      ...
      slash: AugmentedSubmittable<(slashes: Vec<ModuleHomaValidatorListSlashInfo> | (ModuleHomaValidatorListSlashInfo | { validator?: any; tokenAmount?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Vec<ModuleHomaValidatorListSlashInfo>]>;
    ...
    ormlXcm: {
      sendAsSovereign: AugmentedSubmittable<(dest: XcmVersionedLocation | { V3: any } | { V4: any } | { V5: any } | string | Uint8Array, message: XcmVersionedXcm | { V3: any } | { V4: any } | { V5: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [XcmVersionedLocation, XcmVersionedXcm]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    utility: {
      ...
      dispatchAs: AugmentedSubmittable<(asOrigin: AcalaRuntimeOriginCaller | { system: any } | { PolkadotXcm: any } | { CumulusXcm: any } | { Authority: any } | { GeneralCouncil: any } | { FinancialCouncil: any } | { HomaCouncil: any } | { TechnicalCommittee: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AcalaRuntimeOriginCaller, Call]>;
      dispatchAsFallible: AugmentedSubmittable<(asOrigin: AcalaRuntimeOriginCaller | { system: any } | { PolkadotXcm: any } | { CumulusXcm: any } | { Authority: any } | { GeneralCouncil: any } | { FinancialCouncil: any } | { HomaCouncil: any } | { TechnicalCommittee: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AcalaRuntimeOriginCaller, Call]>;
    ...
    xTokens: {
      setMigrationPhase: AugmentedSubmittable<(migrationPhase: OrmlXtokensMigrationPhase | 'NotStarted' | 'InProgress' | 'Completed' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [OrmlXtokensMigrationPhase]>;
