...
import type { AcalaPrimitivesCurrencyAssetIds, AcalaPrimitivesCurrencyAssetMetadata, AcalaPrimitivesCurrencyCurrencyId, AcalaPrimitivesTradingPair, EthereumLog, EvmCoreErrorExitReason, FrameSupportDispatchDispatchInfo, FrameSupportTokensMiscBalanceStatus, KaruraRuntimeOriginCaller, KaruraRuntimeScheduledTasks, ModuleHomaModuleUnlockChunk, ModuleSupportIncentivesPoolId, ModuleXcmInterfaceModuleXcmInterfaceOperation, OrmlVestingVestingSchedule, PalletDemocracyVoteAccountVote, PalletDemocracyVoteThreshold, PalletMultisigTimepoint, RuntimeCommonProxyType, SpRuntimeDispatchError, SpWeightsWeightV2Weight, XcmV3MultiAsset, XcmV3MultiLocation, XcmV3MultiassetMultiAssets, XcmV3Response, XcmV3TraitsError, XcmV3TraitsOutcome, XcmV3Xcm, XcmVersionedMultiAssets, XcmVersionedMultiLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    assetRegistry: {
       ...
       **/
      ForeignAssetRegistered: AugmentedEvent<ApiType, [assetId: u16, assetAddress: XcmV3MultiLocation, metadata: AcalaPrimitivesCurrencyAssetMetadata], { assetId: u16, assetAddress: XcmV3MultiLocation, metadata: AcalaPrimitivesCurrencyAssetMetadata }>;
      /**
       * The foreign asset updated.
       **/
      ForeignAssetUpdated: AugmentedEvent<ApiType, [assetId: u16, assetAddress: XcmV3MultiLocation, metadata: AcalaPrimitivesCurrencyAssetMetadata], { assetId: u16, assetAddress: XcmV3MultiLocation, metadata: AcalaPrimitivesCurrencyAssetMetadata }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    authority: {
       ...
       **/
      Cancelled: AugmentedEvent<ApiType, [origin: KaruraRuntimeOriginCaller, index: u32], { origin: KaruraRuntimeOriginCaller, index: u32 }>;
      /**
       * A scheduled call is delayed.
       **/
      Delayed: AugmentedEvent<ApiType, [origin: KaruraRuntimeOriginCaller, index: u32, when: u32], { origin: KaruraRuntimeOriginCaller, index: u32, when: u32 }>;
      /**
       ...
       **/
      FastTracked: AugmentedEvent<ApiType, [origin: KaruraRuntimeOriginCaller, index: u32, when: u32], { origin: KaruraRuntimeOriginCaller, index: u32, when: u32 }>;
      /**
       ...
       * A call is scheduled.
       **/
      Scheduled: AugmentedEvent<ApiType, [origin: KaruraRuntimeOriginCaller, index: u32], { origin: KaruraRuntimeOriginCaller, index: u32 }>;
      /**
    ...
    honzonBridge: {
       ...
       **/
      BridgedStableCoinCurrencyIdSet: AugmentedEvent<ApiType, [bridgedStableCoinCurrencyId: AcalaPrimitivesCurrencyCurrencyId], { bridgedStableCoinCurrencyId: AcalaPrimitivesCurrencyCurrencyId }>;
      /**
       * User has exchanged Bridge's stable coin to Native's stable coin.
       **/
      FromBridged: AugmentedEvent<ApiType, [who: AccountId32, amount: u128], { who: AccountId32, amount: u128 }>;
      /**
       * User has exchanged Native stable coin to Bridge's stable coin.
       **/
      ToBridged: AugmentedEvent<ApiType, [who: AccountId32, amount: u128], { who: AccountId32, amount: u128 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    idleScheduler: {
       ...
       * A task is added.
       **/
      TaskAdded: AugmentedEvent<ApiType, [taskId: u32, task: KaruraRuntimeScheduledTasks], { taskId: u32, task: KaruraRuntimeScheduledTasks }>;
      /**
