...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    assetRegistry: {
       ...
       **/
      foreignAssetLocations: AugmentedQuery<ApiType, (arg: u16 | AnyNumber | Uint8Array) => Observable<Option<XcmV3MultiLocation>>, [u16]> & QueryableStorageEntry<ApiType, [u16]>;
      /**
       * The storages for CurrencyIds.
       * 
       * LocationToCurrencyIds: map MultiLocation => Option<CurrencyId>
       **/
      locationToCurrencyIds: AugmentedQuery<ApiType, (arg: XcmV3MultiLocation | { parents?: any; interior?: any } | string | Uint8Array) => Observable<Option<AcalaPrimitivesCurrencyCurrencyId>>, [XcmV3MultiLocation]> & QueryableStorageEntry<ApiType, [XcmV3MultiLocation]>;
      /**
    ...
    honzonBridge: {
       ...
       **/
      bridgedStableCoinCurrencyId: AugmentedQuery<ApiType, () => Observable<Option<AcalaPrimitivesCurrencyCurrencyId>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
